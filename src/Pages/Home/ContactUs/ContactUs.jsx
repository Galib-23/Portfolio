...
export const ContactUs = () => {
    ...
    return (
        <div className='mt-28' id='contact'>
            <h2 data-aos="fade-left" className='text-4xl font-bold text-cyan-400 text-center mb-4'>CONNECT WITH ME</h2>
            <div className='flex justify-center'>
                <div className='w-1/3'>
                    <form ref={form} onSubmit={sendEmail}>
                        <label data-aos="fade-right" className="form-control w-full">
                            <div className="label">
                        ...
                        <label data-aos="fade-left" className="form-control w-full">
                            <div className="label">
                        ...
                        <label data-aos="fade-right" className="form-control">
                            <div className="label">
                        ...
                        <input data-aos="fade-left" className='btn btn-outline text-cyan-500 mt-6' type="submit" value="Send Message" />
                    </form>
                </div>
            </div>
        </div>
